...
hypervisor_module-y := src/hypervisor_module.o src/libhypervisor_test.o src/virt_to_phys_shim.o src/host_entrypoint.o
...
$(RUST_LIB_PATH):
	cargo rustc --release -- --emit=obj -C code-model=kernel -C relocation-model=static
